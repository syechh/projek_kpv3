...
if (isset($_POST['login'])){
    ...
    $queryLogin = mysqli_query($koneksi, "SELECT * FROM users
...
<head>
  ...
  <title>Login | Toko bangunan Mutiara</title>
  ...
  <!-- favicon -->
  <link rel="shortcut icon" href="<?= $main_url ?>assets/images/cart.img" type="image/x-icon">
...
<div class="login-box slide-down" style="margin-top: -70px;">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1">Toko bangunan <b>Mutiara</b></a>
    </div>
    <div class="card-body">
      ...
      <form action="" method="post">
        ...
        <div class="input-group mb-4">
         ...
         <p class="my-3 text-center">
          <strong>Copyright &copy; 2023 <span class="text-info">Mutiara</span></strong>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
