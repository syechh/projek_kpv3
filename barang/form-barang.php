            ...
            <div class="row">
              <div class="col-lg-8 mb-3 pr-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="name" value="<?= $msg != '' ? $barang['nama_barang'] : null ?>" placeholder="nama barang" autocomplete="off" autofocus required>
                </div>
                <div class="form-group">
                  ...
                  <select name="satuan" id="satuan" class="form-control" required>
                    <?php
                      if($msg != ""){
                          $satuan = ["item/piece","meter","kg","sak","liter","dus/karton","lembar","batang",];
              ...
              <div class="col-lg-4 text-center px-3">
                ...
                <img src="<?= $main_url ?>assets/images/<?= $msg != '' ? $barang['gambar'] : 'default-brg.png' ?>" class="profile-user-img mb-3 mt-4" alt="">
