...
$dataJual = getData("SELECT * FROM jual_head WHERE no_jual = '$id'");
if (empty($dataJual)) {
...
$itemJual = getData("SELECT * FROM jual_detail WHERE no_jual = '$id'");
if (empty($itemJual)) {
...
<head>
    ...
    <title>Struk Belanja - <?= htmlspecialchars($id) ?></title>
    <style>
        body {
...
<div class="customer-info">
    <p style="margin: 2px 0;">
        <strong>No. Nota:</strong> <?= htmlspecialchars($id) ?><br>
...
<div class="items">
    ...
    <div class="item-row">
        ...
        <div style="display: flex; justify-content: space-between;">
            <span>x <?= number_format($item['harga_jual'],0,',','.') ?></span>
...
<div class="customer-info">
    <strong>Keterangan:</strong> <?= htmlspecialchars($dataJual['keterangan']) ?>
</div>
<?php endif; ?>
